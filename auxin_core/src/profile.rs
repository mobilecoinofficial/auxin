...
///
/// Ciphertext - to be generated by build_set_profile_request() and sent to Signal's web API.
/// Plaintext will not work in any of these fields.
///
...
pub fn sign_payment_address<R: CryptoRng + Rng>(
	...
	// Signature is supposed to be 64 bytes in length
